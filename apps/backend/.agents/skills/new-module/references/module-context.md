...
2. один-два критичных инварианта, которые нельзя безопасно вывести из кода;
3. минимальная карта файлов и команды проверки;
4. ссылка на локальный skill, если подробных сценариев много.
