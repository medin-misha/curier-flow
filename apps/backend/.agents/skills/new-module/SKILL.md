---
name: new-module
description: Создать новый бизнес-модуль backend с нужными handlers, services, моделями, схемами, манифестом, миграцией, AGENTS.md и тестами. Применяй для нового ресурса или новых endpoint'ов, когда каталога модуля ещё нет; существующий модуль изменяй через его локальный skill.
---
