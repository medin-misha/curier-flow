...
Не обходи это правило переходом `cd` внутри уже начатой сессии: контекст
выбирается при запуске Codex.
...
`docs/admin_auth_plan.md` — журнал исходной реализации, не основной living
contract.
